...
const ExcelViewer = () => {
    ...
    const files = ['32_murder_age_sex.xlsx','Persons_Arrested_in_India.xlsx','Crimes_Against_Women.xlsx' ,'Property_Theft_in_India.xlsx' , 'Number_of_crimes_in_india.xlsx','Custodial_Death.xlsx']; // Example array of file names
